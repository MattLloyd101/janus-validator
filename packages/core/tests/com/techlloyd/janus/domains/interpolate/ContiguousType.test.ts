import { ContiguousType, ContiguousTypeValue } from '@/com/techlloyd/janus/domains/interpolate/ContiguousType';
import { IntegerInterpolateStrategy } from '@/com/techlloyd/janus/domains/interpolate/IntegerInterpolateStrategy';
