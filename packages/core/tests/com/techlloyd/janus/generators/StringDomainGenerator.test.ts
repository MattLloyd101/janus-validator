...
import { StringDomain } from '@/com/techlloyd/janus/Domain';
...
describe('StringDomainGenerator', () => {
  it('should generate valid strings', () => {
    ...
    const domain: StringDomain = new StringDomain();
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate strings within length constraints', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(5, 10);
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate strings with minimum length only', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(3);
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate strings with maximum length only', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(undefined, 5);
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate empty strings when minLength is 0', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(0, 0);
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate strings with exact length when minLength equals maxLength', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(5, 5);
    const rng: RNG = {
      random: () => Math.random(),
    };
  ...
  it('should generate valid Unicode scalar values', () => {
    const generator = new StringDomainGenerator();
    const domain: StringDomain = new StringDomain(10, 20);
    const rng: RNG = {
      random: () => Math.random(),
    };
