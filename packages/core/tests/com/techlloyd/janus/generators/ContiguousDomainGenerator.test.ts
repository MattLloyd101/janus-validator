...
describe('ContiguousDomainGenerator', () => {
  describe('integer generation', () => {
    it('should generate integers within range', () => {
      ...
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.INTEGER, 0, 10);
      const rng: RNG = {
        random: () => Math.random(),
      };
    ...
    it('should generate minimum value when RNG returns 0', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.INTEGER, 5, 15);
      const rng: RNG = {
        random: () => 0.0,
      };
    ...
    it('should generate negative integers', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.INTEGER, -10, -1);
      const rng: RNG = {
        random: () => Math.random(),
      };
    ...
    it('should generate all values in small range', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.INTEGER, 0, 3);
      const rng: RNG = {
        random: () => Math.random(),
      };
    ...
    it('should handle single value range', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.INTEGER, 42, 42);
      const rng: RNG = {
        random: () => Math.random(),
      };
  ...
  describe('floating point generation', () => {
    it('should generate floats within range', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.FLOAT, 0, 1);
      const rng: RNG = {
        random: () => Math.random(),
      };
    ...
    it('should generate minimum value when RNG returns 0', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.FLOAT, 10, 20);
      const rng: RNG = {
        random: () => 0.0,
      };
    ...
    it('should scale to range correctly', () => {
      const generator = new ContiguousDomainGenerator();
      const domain: ContiguousDomain = new ContiguousDomain(ContiguousType.FLOAT, 100, 200);
      const rng: RNG = {
        random: () => 0.5,
      };
